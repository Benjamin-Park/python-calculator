...
def create_buttons(self):
    ...
    self.button_3 = tk.Button(parent, text="3", command=lambda: self.button_press("3"), width=2, fg=self.theme_data["button"]["fg"], bg=self.theme_data["button"]["bg"])
    self.button_4 = tk.Button(parent, text="4", command=lambda: self.button_press("4"), width=2, fg=self.theme_data["button"]["fg"], bg=self.theme_data["button"]["bg"])
    self.button_5 = tk.Button(parent, text="5", command=lambda: self.button_press("5"), width=2, fg=self.theme_data["button"]["fg"], bg=self.theme_data["button"]["bg"])
    self.button_6 = tk.Button(parent, text="6", command=lambda: self.button_press("6"), width=2, fg=self.theme_data["button"]["fg"], bg=self.theme_data["button"]["bg"])
    self.button_7 = tk.Button(parent, text="7", command=lambda: self.button_press("7"), width=2, fg=self.theme_data["button"]["fg"], bg=self.theme_data["button"]["bg"])
    self.button_8 = tk.Button(parent, text="8", command=lambda: self.button_press("8"), width=2, fg=self.theme_data["button"]["fg"], bg=self.theme_data["button"]["bg"])
    self.button_9 = tk.Button(parent, text="9", command=lambda: self.button_press("9"), width=2, fg=self.theme_data["button"]["fg"], bg=self.theme_data["button"]["bg"])
    ...
    self.button_divide = tk.Button(parent, text="÷", command=lambda: self.button_press("/"), width=2, fg=self.theme_data["button_operator"]["fg"], bg=self.theme_data["button_operator"]["bg"])
    self.button_solve = tk.Button(parent, text="=", command=self.solve, width=2, fg=self.theme_data["button_exec"]["fg"], bg=self.theme_data["button_exec"]["bg"])
